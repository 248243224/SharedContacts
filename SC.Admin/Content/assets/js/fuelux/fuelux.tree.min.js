	...
	var Tree = function(element, options) {
		...
		if( this.options.folderSelect ){
			this.$element.off("click", ".tree-folder-header");
                        this.$element.on('click', '.ace-icon', $.proxy( function(ev) { this.selectFolder($(ev.currentTarget).parent()) }, this));
                        this.$element.on('click', '.tree-folder-name', $.proxy( function(ev) { this.selectItem($(ev.currentTarget).parent()) }, this));
